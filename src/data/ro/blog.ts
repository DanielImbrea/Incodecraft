...
export const blogPosts: BlogPost[] = [
  {
    ...
    contentHtml: `
      ...
      <p>Pentru piața din România, un website profesional, custom, pentru o afacere mică se încadrează de obicei în intervalul €350–€3.000. La INCODECRAFT, proiectele pot pleca și de la €350, când proiectul e clar și bine definit. Avem un flux constant de proiecte, iar pentru noi contează mai puțin să maximizăm fiecare factură și mai mult să livrăm corect, să fii mulțumit și să ne recomanzi — astfel ajungem la mai mulți clienți pe termen lung, fără compromisuri la calitate. Un site de marketing mai ambițios, cu un design system personalizat și mai multe pagini, ajunge de regulă între €1.000–€5.000. Odată ce proiectul intră în teritoriul aplicației web custom — dashboard-uri, portaluri, funcționalitate nestandard — prețul trece la oferte specifice proiectului, nu la un pachet fix.</p>
