...
export const services: Service[] = [
  ...
  },
  {
    ...
    name: "Aplicații web & mobile",
    shortName: "Aplicații",
    tagline: "Software personalizat pentru web și pentru iOS/Android — acolo unde spreadsheet-urile nu mai sunt de ajuns.",
    summary:
      "Aplicații web, aplicații mobile pentru iOS și Android (native sau cross-platform), dashboard-uri, CRM-uri, sisteme de booking și portaluri clienți — construite în jurul workflow-ului tău real, nu un template rigid off-the-shelf.",
    whoFor: [
      "Afaceri care coordonează operațiuni prin spreadsheet-uri sau tool-uri deconectate",
      "Echipe care au nevoie de un portal clienți, aplicație mobilă sau sistem de booking",
      "Companii care au nevoie de software adaptat unui proces intern specific",
      "Produse care trebuie să funcționeze atât în browser, cât și pe telefon",
    ],
    whatIBuild: [
      "Aplicații web și produse SaaS",
    ...
    typicalFeatures: [
      ...
      "API partajat între web și mobile, când are sens",
      "Publicare în App Store și Google Play, cu suport la lansare",
  ...
  },
  {
    ...
    whatIBuild: [
      "Integrări AI în aplicații web și mobile existente",
