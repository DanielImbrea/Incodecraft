...
export const services: Service[] = [
  ...
  },
  {
    ...
    tagline: "Custom software for web and for iOS/Android — for the parts of your business spreadsheets can't handle.",
    summary:
      "Web applications, mobile apps for iOS and Android (native or cross-platform), dashboards, CRMs, booking systems and customer portals — built around your actual workflow, not a rigid off-the-shelf template.",
    whoFor: [
      "Businesses coordinating operations across spreadsheets or disconnected tools",
      "Teams that need a customer portal, mobile app or booking system",
      "Companies that need software matched to a specific internal process",
      "Products that need to work in the browser and on phone",
    ],
    whatIBuild: [
    ...
    typicalFeatures: [
      ...
      "Shared API between web and mobile where it makes sense",
  ...
  },
  {
    ...
    whatIBuild: [
      "AI integrations in existing web and mobile applications",
