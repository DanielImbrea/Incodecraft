...
export const blogPosts: BlogPost[] = [
  {
    ...
    contentHtml: `
      ...
      <p>For the Romanian market, a professionally built, custom small-business website commonly falls in the €350–€3,000 range. At INCODECRAFT, projects can start from €350 when the project is clearly and well defined. We work with a steady flow of clients, and for us what matters less is maximising each invoice and what matters more is delivering properly, leaving you satisfied and earning your recommendation — that is how we grow together over the long term, without compromising on quality. A more ambitious marketing website with a bespoke design system and more pages typically lands between €1,000–€5,000. Once a project moves into custom web application territory — dashboards, portals, non-standard functionality — pricing moves into project-specific quotes rather than a fixed package.</p>
